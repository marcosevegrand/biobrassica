...
<section class="relative bg-paper text-forest py-16 overflow-hidden border-t border-b border-stone/30">
  ...
  <div class="relative z-10 max-w-3xl mx-auto px-6 text-center"><h2 class="text-2xl font-serif italic mb-4">Prove a diferença do biológico</h2><p class="text-forest/75 mb-8">Visite a nossa loja online ou passe por uma das nossas lojas físicas.</p><a href="{{ route('shop.home') }}" class="inline-block px-8 py-3 bg-forest text-paper text-sm uppercase tracking-widest font-medium rounded-sm hover:bg-forest/90 transition-colors">Visitar Loja</a></div>
</section>
@endsection

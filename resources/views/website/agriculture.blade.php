...
<section class="relative bg-paper text-forest py-16 overflow-hidden border-t border-b border-stone/30">
  ...
  <div class="relative z-10 max-w-3xl mx-auto px-6 text-center"><h2 class="text-2xl font-serif italic mb-4">Prove a diferença do biológico</h2><p class="text-forest/75 mb-8">Consulte a nossa loja online ou visite uma das nossas lojas físicas.</p><x-shop-cta variant="agriculture" label="Ver Loja" :shop-cta="$shopCta" /></div>
</section>
@endsection
